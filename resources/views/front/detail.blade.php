                ...
                <div class="row">
                    <div class="col-md-9 my-2  p-4">
                        <div class="detail-header">
                            <img src="{{url('public/uploads/img_article/img-menambah-lagi-coba.png')}}" style="width: 100%" alt="">
                        </div>
                        <div class="detail-content my-3 p-3">
                            <h2 >Rp. {{number_format($pd[0]->hargaP, '0', '.',',')}}</h2>
                            <div class="line"></div>
                            <ul class="nav nav-tabs my-3" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Meeting Point</a>
                                </li>
                                <li class="nav-item">
